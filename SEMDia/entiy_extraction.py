...
from src.model2 import BertWordPair
...
class Main:
    ...
    def train_iter(self):
        ...
        for i, data in enumerate(train_data):
            loss, _ = self.model(self.global_epoch, **data)
    ...
    def test(self):
        ...
        PATH = self.save_path
        # PATH = os.path.join(self.config.target_dir, "{}_{}.pth.tar").format(self.config.lang, 'entiy')
        ...
        self.evaluate_iter(self.trainLoader)
        result2 = self.relation_metric.compute('train')
